...
void SteppingVerbose::TrackingStarted()
{
    ...
    if (verboseLevel > 0) {
        G4cout << std::setw(5) << "#Step#"     << "    "
               ...
               << std::setw(12) << "Volume"    << "  "
               << std::setw(12) << "Process"   << G4endl;

        G4cout << std::setw(5) << fTrack->GetCurrentStepNumber() << " "
               << std::setw(12) << fTrack->GetPosition().x() / um
               << std::setw(12) << fTrack->GetPosition().y() / um
               << std::setw(12) << fTrack->GetPosition().z() / um
               << std::setw(10) << fTrack->GetKineticEnergy() / keV
               << std::setw(10) << fStep->GetTotalEnergyDeposit() / keV
               << std::setw(12) << fStep->GetStepLength() / um //G4BestUnit(fStep->GetStepLength(),"Length")
               << std::setw(12) << fTrack->GetTrackLength() / um
               << std::setw(12) << fTrack->GetVolume()->GetName()
               << "   initStep" << G4endl;
    }
